...
public class ResetCommand extends CustomCommand {
    ...
    public boolean Run(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (!wantsReset) {
            wantsReset = true;
            server.broadcast(Utils.TextWithCommands(sender.getName(), "wants to reset the run. Please", Utils.Command("confirm", "/reset confirm"), "or", Utils.Command("cancel", "/reset cancel")));
